...
def bit_counter(dims=[15, 1000, 16], lrate=0.1, showint=2, mbs=10, vint=100, softmax=True):
    ...
    gann_bit_counter.run(5000, None, False, 1)


def parity(dims=[10, 200, 2], lrate=0.1, showint=2, mbs=10, vint=1000, softmax=True):
    def cfunc_parity():
    ...
    gann_parity.run(12000, None, False, 1)
